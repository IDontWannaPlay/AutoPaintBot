...
if("TRUE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /home/simuser/ws_moveit/src/franka_ros/franka_description)
  set(franka_description_DEVEL_PREFIX /home/simuser/ws_moveit/devel/.private/franka_description)
  ...
  set(franka_description_INSTALL_PREFIX /home/simuser/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simuser/ws_moveit/src/franka_ros/franka_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/simuser/ws_moveit/devel/.private/franka_description/lib;/home/simuser/ws_moveit/devel/lib;/opt/ros/melodic/lib)

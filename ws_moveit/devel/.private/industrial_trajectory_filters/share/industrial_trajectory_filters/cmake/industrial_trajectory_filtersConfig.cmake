...
if("TRUE" STREQUAL "TRUE")
  set(industrial_trajectory_filters_SOURCE_PREFIX /home/simuser/ws_moveit/src/industrial_core/industrial_trajectory_filters)
  set(industrial_trajectory_filters_DEVEL_PREFIX /home/simuser/ws_moveit/devel/.private/industrial_trajectory_filters)
  ...
  set(industrial_trajectory_filters_INSTALL_PREFIX /home/simuser/ws_moveit/install)
...
if(NOT "/home/simuser/ws_moveit/src/industrial_core/industrial_trajectory_filters/include " STREQUAL " ")
  set(industrial_trajectory_filters_INCLUDE_DIRS "")
  set(_include_dirs "/home/simuser/ws_moveit/src/industrial_core/industrial_trajectory_filters/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_trajectory_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/simuser/ws_moveit/src/industrial_core/industrial_trajectory_filters/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/simuser/ws_moveit/devel/.private/industrial_trajectory_filters/lib;/home/simuser/ws_moveit/devel/lib;/opt/ros/melodic/lib)
